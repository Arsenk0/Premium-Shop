...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'prodforsmtp@gmail.com')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'tkgp zwwo zghm akir ')
EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'True') == 'True'
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'prodforsmtp@gmail.com')
